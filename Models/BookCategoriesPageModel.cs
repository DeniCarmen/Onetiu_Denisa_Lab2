...
namespace Onetiu_Denisa_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Onetiu_Denisa_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Onetiu_Denisa_Lab2Context context,
